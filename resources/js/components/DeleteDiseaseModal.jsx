...
function DeleteDiseaseModal({ enfermedad, onClose, onConfirm }) {
  return (
      ...
      <div className="bg-white rounded-3xl shadow-2xl w-full max-w-md mx-4 animate-scale-in">
        <div className="p-8 text-center">
          ...
          <p className="text-gray-600 mb-6">
            ¿Estás seguro de que deseas eliminar la enfermedad{' '}
            <strong className="text-gray-800">{enfermedad.nombre}</strong>?
          </p>
